...
class Fetcher {
  constructor(store, options = {}) {
    ...
    let fetchFunc = options.fetch || typeof globalThis !== 'undefined' && globalThis.fetch || typeof global !== 'undefined' && (global.solidFetcher || global.solidFetch || global.fetch) || typeof window !== 'undefined' && (window.solidFetcher || window.solidFetch || window.fetch);
    if (!fetchFunc) {
