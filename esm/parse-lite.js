...
import { TurtleContentType, N3ContentType } from './types';
 ...
 */
export function registerParser(contentType, parser) {
 ...
 */
export default function parseLite(str, kb, base, contentType = 'text/turtle', callback) {
